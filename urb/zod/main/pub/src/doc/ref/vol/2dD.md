...
Mapifiy. Accepts a list of cells and produces a map of key-value pairs
from the left-right cell pairs of the list.
...
XXX THIS APPEARS TO BE A COPY OF ++sa. QUEUIFY IS NOT IMPLEMENTED YET.
XXX
