...
Accept any tree and produce a loobean indicating whether the tree is a
set.
...
Accept a gate which accepts any noun and produce a loobean. Slam the
gate with each member of set 'a', produce the logical AND of the
transformed set.
...
Accept a gate which accepts any noun and produce a loobean. Slam the
gate with each member of set 'a', produce the logical OR of the
transformed set.
...
Accept a list 'b' with members of the same type as the set 'a' and
produce the union set of 'a' and 'b'.
...
Accepts any noun and produces the loobean indicating whether or not that
value (n.a) exists in 'a'.
...
Accept any noun 'b' and produce the set 'a' with 'b' added to its sorted
location.
...
Accept a noun and a binary gate. Produce the 'a' with each member 'n.a'
replaced by (c n.a b).
...
Accept a list of elements of the set and produce a cell of the set with
the list concatenated.
