...
Compare two [line column] pairs and produce the one which is farther
along in text.
...
Produce the beginning of the next line after a newline character or
increment the column number - The index of the next character to be
parsed.
