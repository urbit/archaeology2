...
Parse ASCII character 92, bas. Note the extra '' in the slam of bas with
just is to escape the escape character, bas.
...
Parse ASCII character 123, kel. Note that this, with ker, opens and
closes a Hoon expression for Hoon string interpolation. Escape kel to
parse it.
...
Parse ASCII character 39, soq. Note the extra '' in the slam of soq with
just is to escape the first soq because soq denotes a crip.
