...
Why `[[0 4] [0 3] [0 11]]`? Our goal in calling the function is to take
...
The battery can be one *or more* formulas, each of which is applied with
...
Third, now we can't just call the gate directly. We have to actually
